...
ActiveRecord::Schema[7.0].define(version: 2024_05_26_201314) do
  ...
  create_table "contacts_contact", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.json "full_name", null: false
    t.string "company", null: false
    t.text "photo_path", size: :long, null: false
    t.json "phone_no", null: false
    t.json "email", null: false
  end
